    ...
    private void createShortcuts() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N_MR1) {
            ...
            ShortcutInfo call108Shortcut = new ShortcutInfo.Builder(this, "call_108")
                    ...
                    .setIcon(Icon.createWithResource(this, R.drawable.ic_call_emergency_services))
                    .setRank(5)
                    .build();
            ...
            ShortcutInfo nearestHospitalShortcut = new ShortcutInfo.Builder(this, "nearest_hospital")
                    ...
                    .setIcon(Icon.createWithResource(this, R.drawable.ic_hospital))
                    .setRank(2)
                    .build();
            ...
            ShortcutInfo nearestDoctorShortcut = new ShortcutInfo.Builder(this, "nearest_doctor")
                    ...
                    .setIcon(Icon.createWithResource(this, R.drawable.ic_doctor))
                    .setRank(1)
                    .build();
